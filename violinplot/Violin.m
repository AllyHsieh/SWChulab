            ...
            switch args.DataStyle
                ...
                case 'scatter'
                    if ~isempty(data2)
                       jitter = 1*(rand(size(data))); %right
                        obj.ScatterPlot = ...
                            scatter(pos , data, args.MarkerSize, 'filled');
                        % plot the data points within the violin area
                        if length(densityC) > 1
                            jitterstrength = interp1(valueC, densityC*widthC, data2);
                        else % all data is identical:
                       ...
                       obj.ScatterPlot2 = ...
                            scatter(jitterstrength, data2, args.MarkerSize, 'filled');         
                    else 
                        obj.ScatterPlot = ...
                            scatter(jitterstrength, data, args.MarkerSize, 'filled');
