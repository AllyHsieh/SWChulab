...
%%
revise by kai-chun 2023/03 - NTHU DAIL lab
"""
...
if download_demo_file:
    ...
    datasets_path = 'datasets/240617DrosophilaImage_57.5Hz'  # folder containing tif files for training
...
train_datasets_size = 1500     # dataset size for training (the number of patches) **t size of tif**
patch_x = 64             # the width and height of 3D patches
patch_y = 64             # the width and height of 3D patches
...
if display_images:
    ...
    display_length = 200  # the frames number of the noise movie
