...
if download_demo_file:
    file_name='29_4_2_4' # select the demo file you want to test (e.g. 'ATP_3D', 'fish_localbrain', 'NP_3D', ...)
    datasets_path, denoise_model = download_demo(download_filename=file_name)
else:
    datasets_path = 'datasets/010824SCNtime v2_4_4_64_128_15%_90s_z320_notimecorr'  # folder containing tif files for testing
    denoise_model = '010824SCNtime v2_4_4_64_128_15%_90s_z320_notimecorr_202408141806'  # A folder containing pth models to be tested

# %% First setup some parameters for testing
test_datasize = 1145                # the number of frames to be tested (test all frames if the number exceeds the total number of frames in a .tif file)
GPU = '0'                             # the index of GPU you will use for computation (e.g. '0', '0,1', '0,1,2')
patch_x = 128                      # the width and height of 3D patches
patch_y =128
patch_t = 1145                        # the time dimension of 3D patches
