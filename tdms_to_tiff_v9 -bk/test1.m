...
s1 = 'D:\Yintzu\2022_0913_sample_data\move_1\'; 
s4 = 'D:\Yintzu\2022_0913_sample_data\move_1\ch1_out\'; 
%save 4D stack
save_rawmat = 1; % if true save, else not save
output_rawdata_filename = "D:\Yintzu\2022_0913_sample_data\move_1\export_out.mat";
% run
sorting3D;
%--------------------------------------------------------------------------
%% time correction
...
% save raw data
output_path = "D:\Yintzu\2022_0913_sample_data\move_1\"; %assign the output path
